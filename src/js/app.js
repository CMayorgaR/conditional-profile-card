...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
    ...
    variables.twitter == null ? "@Usuario" : variables.twitter
  }<i class="fab fa-twitter"></i></a></li>
            <li><a href="https://github.com/${variables.github}">${
    variables.github == null ? "@Usuario" : variables.github
  }<i class="fab fa-github"></i></a></li>
            <li><a href="https://linkedin.com/${variables.linkedin}">${
    variables.linkedin == null ? "Usuario" : variables.linkedin
  }<i class="fab fa-linkedin"></i></a></li>
            <li><a href="https://instagram.com/${variables.instagram}">${
    variables.instagram == null ? "Usuario" : variables.instagram
